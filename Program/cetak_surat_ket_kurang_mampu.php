<?php
    ...
    <body>
        <div id=halaman>
            ...
            <br>
            <p  class="para">Benar nama yang tercantum diatas adalah warga <?php echo $cetak1['dusun']; ?> Desa Tanampedagi. Dengan sepengetahuan kami dan sesuai data yang ada di kantor Desa orang tersebut diatas benar keluarga kurang mampu <b>( KELUARGA BERPENGHASILAN RENDAH )</b> </p>
