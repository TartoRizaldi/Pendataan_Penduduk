<?php
    ...
    $data1 = mysqli_query($conn, "SELECT * FROM data_pendatang WHERE nik='$nik'");
    ...
    <body>
        <div id=halaman>
            ...
            <p id=judul2>Nomor : 500/……/ PEMDES-TPDG/ XII/ 2022</p>
            <br>

            <p  class="para">Yang bertanda tangan di bawah ini Kepala Desa Tanampedagi Kecamatan Ampibabo Kabupaten Parigi Moutong, menerangkan kepada  :</p>
            ...
            <br>
            <br>
            <p  class="para">Bahwa nama tersebut di atas, adalah benar penduduk yang berdomisili di <?php echo $cetak1['dusun']; ?> Desa Tanampedagi Kecamatan Ampibabo, dan yang bersangkutan mempunyai suatu usaha. Usaha tersebut sampai saat ini tetap berjalan lancar.</p>
