<?php
    ...
    $nik = $_GET['nik'];
    $data_penduduk = mysqli_query($conn, "SELECT * FROM data_penduduk WHERE nik='$nik'");
                    ...
                    <form autocomplete="off" required="" method="POST" action="acc_action.php">
                        <div class="card-body">
                            ...
                            <div class="input_down">
                                <a href="all_data_admin.php" class="btn btn-primary btn-icon-split">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="conf" id="exampleInputStatus" required="" name="status" min="0" value="<?php echo $data['status']; ?>" readonly>
                                <hr class="sidebar-divider my-0 garis">
                            </div>
                        </div>
                        <!-- /.card-body -->
