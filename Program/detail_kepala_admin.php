<?php
    ...
    $nik = $_GET['nik'];
    $data_penduduk = mysqli_query($conn, "SELECT * FROM data_kepala_keluarga WHERE nik='$nik'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Detail Data Kepala Keluarga</h1>

                    <form autocomplete="off" required="" method="POST" action="acc_action.php">
                        <div class="card-body">
                            <br>
                            <div class="input_down">
                                <a href="all_data_kep_admin.php" class="btn btn-primary btn-icon-split">
                            ...
                            <div class="form-group">
                                <label for="exampleInputDusun" class="input label">Dusun</label>
                                <input type="text" class="conf" id="exampleInputDusun" required="" name="dusun" min="0" value="<?php echo $data['dusun']; ?>" readonly>
                                <hr class="sidebar-divider my-0 garis">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputAgama" class="input label">Pendidikan</label>
                                <input type="text" class="conf" id="exampleInputAgama" required="" name="pendidikan" min="0" value="<?php echo $data['pendidikan']; ?>" readonly>
                                <hr class="sidebar-divider my-0 garis">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputAgama" class="input label">Pekerjaan</label>
                                <input type="text" class="conf" id="exampleInputAkun" required="" name="pekerjaan" min="0" value="<?php echo $data['pekerjaan']; ?>" readonly>
                                <hr class="sidebar-divider my-0 garis">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="conf" id="exampleInputNo" required="" name="no_telp" min="0" value="<?php echo $data['no_telp']; ?>" readonly>
                                <hr class="sidebar-divider my-0 garis">
                            </div>
                            <div class="form-group">
