<?php
    ...
    $nik = $_GET['nik'];
    $data_penduduk = mysqli_query($conn, "SELECT * FROM data_penduduk_pindah WHERE nik='$nik'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Detail Data Penduduk Pindah</h1>

                    <form autocomplete="off" required="" method="POST" action="">
                        <div class="card-body">
                            <br>
                            <div class="input_down">
                                <a href="all_data_pin_admin.php" class="btn btn-primary btn-icon-split">
                            ...
                            <div class="form-group">
                                <label for="exampleInputDusun" class="input label">Dari Dusun</label>
