        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Input Data Pendatang</h1>

                    <form autocomplete="off" required="" method="POST" action="input_data_pendatang_admin_action.php">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputTtl" class="input">Dusun</label>
                                <input type="text" class="form-control input" id="exampleInputDusun" placeholder="Masukkan Dusun" required="" name="dusun">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input" id="sel1" name="gol_darah" id="exampleInputGender">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control input" id="exampleInputNo" placeholder="Masukkan No Telp" required="" name="no_telp">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control input" id="sel1" name="status" id="exampleInputStatus">
                                    ...
                                    <option required="Menikah">Menikah</option>
                                    <option required="Belum Menikah">Belum Menikah</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputTtlMulai" class="input">TTL Mulai</label>
                                <input type="date" class="form-control input" id="exampleInputTtlMulai" required="" name="ttl_mulai">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputAkun" class="input">Di sampaikan oleh</label>
                                <input type="text" class="form-control input" id="exampleInputAkun" required="" name="username" min="0" value="<?php echo $_SESSION['username_akun']; ?>" readonly>
                            </div>
                        </div>
                        <!-- /.card-body -->
