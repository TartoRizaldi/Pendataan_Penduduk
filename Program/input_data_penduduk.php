        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
                    ...
                    <form autocomplete="off" required="" method="POST" action="input_data_penduduk_action.php">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control input" id="exampleInputNo" placeholder="Masukkan No Telp" required="" name="no_telp" min="0">
                            </div>
                            <div class="form-group">
