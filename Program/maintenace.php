            ...
            <div id="content">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Cari berdasarkan NIK . . . ."
                                aria-label="Search" aria-describedby="basic-addon2" name="inputnik">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        <div class="error mx-auto" data-text="T_T">T_T</div>
                        <br>
                        <p class="lead text-gray-800 mb-5">Maintenance</p>
                        <p class="text-gray-500 mb-0">Sedang dalam perbaikan</p>
