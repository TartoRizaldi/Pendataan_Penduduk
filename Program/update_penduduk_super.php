        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
                    ...
                    <form autocomplete="off" required="" method="POST" action="update_penduduk_super_action.php">
                        <div class="card-body">
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control input" id="exampleInputTtl" required="" name="ttl" min="0" value="<?php echo $data['ttl']; ?>" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input" id="exampleInputAlamat" required="" name="alamat" min="0" value="<?php echo $data['alamat']; ?>" >
                            </div>
                            <div class="form-group">
