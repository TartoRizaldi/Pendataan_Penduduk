        ...
        if (isset($_POST['submit'])) {
            ...
            if ($gender == "L" && $status == "Menikah") {
                if ($nik == $data2['nik']) {
                    ...
                    header("location: all_data.php?update=success");
                } else {
                    $simpanData2 = mysqli_query($conn, "INSERT INTO data_kepala_keluarga VALUES ('$nik','$nama','$agama','$gender','$ttl','$dusun','$alamat','$pendidikan','$pekerjaan','$gol_darah','$no_telp','$status','$ha')");
