<?php
    ...
    $nik = $_GET['nik'];
    $dataUbah = mysqli_query($conn, "SELECT * FROM data_penduduk_pindah WHERE nik='$nik'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Update Data Penduduk Pindah</h1>

                    <form autocomplete="off" required="" method="POST" action="update_pin_super_action.php">
                        <div class="card-body">
                            <br>
                            ...
                            <div class="form-group">
                                <label for="exampleInputDusun" class="input">Dari Dusun</label>
